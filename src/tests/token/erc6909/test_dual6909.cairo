...
fn setup_camel() -> (DualCaseERC6909, IERC6909CamelDispatcher) {
    ...
    (DualCaseERC6909 { contract_address: target }, IERC6909CamelDispatcher { contract_address: target })
}
...
fn setup_erc6909_panic() -> (DualCaseERC6909, DualCaseERC6909) {
    ...
    (DualCaseERC6909 { contract_address: snake_target }, DualCaseERC6909 { contract_address: camel_target })
}
