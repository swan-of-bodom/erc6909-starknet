...
use erc6909::tests::mocks::erc6909_metadata_mocks::DualCaseERC6909MetadataMock;
use erc6909::tests::utils::constants::{OWNER, SPENDER, RECIPIENT, SUPPLY, ZERO};
use erc6909::tests::utils;
use erc6909::token::erc6909::ERC6909Component::InternalImpl as InternalERC6909Impl;
use erc6909::token::erc6909::extensions::ERC6909MetadataComponent::{ERC6909MetadataImpl, InternalImpl,};
use erc6909::token::erc6909::extensions::ERC6909MetadataComponent;
...
type ComponentState = ERC6909MetadataComponent::ComponentState<DualCaseERC6909MetadataMock::ContractState>;
