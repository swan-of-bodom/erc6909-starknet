...
use erc6909::tests::mocks::erc6909_token_supply_mocks::DualCaseERC6909TokenSupplyMock;
use erc6909::tests::utils::constants::{OWNER, SPENDER, RECIPIENT, SUPPLY, ZERO};
use erc6909::tests::utils;
use erc6909::token::erc6909::ERC6909Component::{InternalImpl as InternalERC6909Impl, ERC6909Impl};
use erc6909::token::erc6909::extensions::ERC6909TokenSupplyComponent::{ERC6909TokenSupplyImpl, InternalImpl,};
...
type ComponentState = ERC6909TokenSupplyComponent::ComponentState<DualCaseERC6909TokenSupplyMock::ContractState>;
