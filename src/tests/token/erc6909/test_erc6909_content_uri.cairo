...
use erc6909::tests::mocks::erc6909_content_uri_mocks::DualCaseERC6909ContentURIMock;
use erc6909::tests::utils::constants::{OWNER, SPENDER, RECIPIENT, SUPPLY, ZERO, BASE_URI, BASE_URI_2};
use erc6909::tests::utils;
use erc6909::token::erc6909::ERC6909Component::InternalImpl as InternalERC6909Impl;
use erc6909::token::erc6909::extensions::ERC6909ContentURIComponent::{ERC6909ContentURIImpl, InternalImpl,};
use erc6909::token::erc6909::extensions::ERC6909ContentURIComponent;
...
type ComponentState = ERC6909ContentURIComponent::ComponentState<DualCaseERC6909ContentURIMock::ContractState>;
